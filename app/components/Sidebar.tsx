  ...
  return (
    <aside className={styles.sidebar}>
      <div className={styles.profileSection}>
        ...
        <h1 className={styles.name}>Jan Beyati</h1>
        <div className={styles.titleBadge}>Software Engineer</div>
      </div>
      ...
      <div className={styles.contactSection}>
        <div className={styles.contactItem}>
          ...
          <div className={styles.contactDetails}>
            ...
            <span className={styles.contactValue}>Contact via social links</span>
          </div>
        </div>
        ...
        <div className={styles.contactItem}>
          ...
          <div className={styles.contactDetails}>
            ...
            <span className={styles.contactValue}>Ottawa, Canada</span>
          </div>
        </div>
      </div>
      ...
      <div className={styles.socialSection}>
        ...
        <a href="#" className={styles.socialIcon} aria-label="Resume">
